...
<% 		
	...
	if((id !=null && type.equals("customer")) || (id !=null && type.equals("guide"))){
		...
		ResultSet rs = service.textbytitle(title);
	...
	<table style="margin-left:200px; line-height:50px;">
		...
		<tr>
			...
			<td>
				<a><%=rs.getString(2)%></a>
				<input type="hidden" name="Sender_id" value="<%=rs.getString(2)%>">
			</td>
		</tr>
		<tr>
			<th>받은사람</th>
			<td>
				<a><%=rs.getString(3)%></a>
				<input type="hidden" name="Receiver_id" value="<%=rs.getString(3)%>">
			</td>
		</tr>
		<tr>
			<th>내용</th>
	...
	<input type="submit" value="답장" style="float:right; margin-top:25px;">
	</form>
	</article>
	<%
		}
