...
<body>
	...
	<form action="guidecourseInsert.do">
		<div class="main">
			...
			<div class="site1">
				<div class="main_2 main_common">고객 인원 수</div>
				<input id="form_box" type="text" class="int" maxlength="20"
					title="고객 인원 수 입력" placeholder="여행 인원 수를 입력해주세요" name="Customer_num">
			</div>
			<div class="site1">
				<div class="main_3 main_common">예산</div>
				<input id="form_box" type="text" title="예산 입력"
					placeholder="예산을 입력해주세요" name="Budget">
			</div>
			<div class="site1">
			<div class="main_3 main_common">날짜</div>
	...
	<%
		...
		ResultSet rs = service.SelectByGuide(id);
	%>
	<article>
