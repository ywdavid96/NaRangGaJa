...
<body>
	...
	<form action="guideInsert.do">
		<div class="main">
			<div class="site1" style="margin-bottom:50px;">
				<h1>회원가입</h1>
			</div>
			...
			<div class="site1">
				...
				<input id="form_box" type="text" class="int" maxlength="20"
					title="아이디 입력" value="<%=session.getAttribute("id") %>" name="Guide_ID" readonly>
			</div>
			<div class="site1">
				<div class="main_2 main_common">비밀번호</div>
				<input id="form_box" type="text" class="int" maxlength="20"
					title="비밀번호 입력" value="" name="Guide_PWD" readonly>
			</div>
			<div class="site1">
				<div class="main_3 main_common">이름</div>
				<input id="form_box" type="text" title="이름 입력"
					value="<%=session.getAttribute("name") %>" name="Guide_name" readonly>
			</div>
			<div class="site1">
