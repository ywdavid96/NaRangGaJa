...
<body>
	...
	<div class="infor" style="background-color:#FFFAFA;">
		<header class="head" style="margin-top:30px;">
		<p class="normal"
			style="color: black; font-weight: bold; font-size: 25px">&nbsp;&nbsp;정보변경</p>
		</header>
		<%
		while (rs.next()) {
		%>
		<div class="container">
			...
			<form action="customerUpdate.do" method="get">
				&nbsp;&nbsp;아이디&nbsp;:&nbsp;&nbsp;&nbsp;<input type="text" readonly value=<%=rs.getString(1)%> name="Customer_ID">
			비밀번호 : <input type="text" value=<%=rs.getString(2)%> name="Customer_PWD"><br> <br>
			&nbsp;&nbsp;이&nbsp;&nbsp;름&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(3)%> name="Customer_name">
			&nbsp;&nbsp;S&nbsp;N&nbsp;S : &nbsp;&nbsp;<input type="text" value=<%=rs.getString(4)%> name="SNS_code"><br> <br>
			&nbsp;&nbsp;성&nbsp;&nbsp;별&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(5)%> name="Gender">
			&nbsp;&nbsp;나&nbsp;&nbsp;이&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(6)%> name="Age"><br> <br>	
