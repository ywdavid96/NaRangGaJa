...
<body>
	...
	if(id !=null && type.equals("customer")){
		//고객이 로그인 했을 경우
		ResultSet rs = service.ShowResults(type, region, num, gender, age, start_date, end_date);
...
<article style="margin-bottom:50px;">
	...
	<table class="blueone" cellspacing="0" style="margin:10px auto;">
		...
		<tr>
			...
			<td><button id="send-to-btn" href="#" onclick="sendToCustomer();" style="height: 45px; background-color: orange; border-radius: 5px; border-color: white; color: white; border: none; padding-left: 10px; padding-right: 10px; margin-left: 5px;">
			확인</button></td>
		</tr>	
  ...
  function sendToCustomer() {
	...
	<table class="blueone" cellspacing="0" style="margin:10px auto;">
		...
		<tr>
			...
			<td><%=rs2.getString(7)%></td>
			<td><%=rs2.getString(8)%></td>
			<td><button id="send-to-btn" href="#" onclick="sendToGuide();" style="height: 45px; background-color: orange; border-radius: 5px; border-color: white; color: white; border: none; padding-left: 10px; padding-right: 10px; margin-left: 5px;">확인</button></td>
		</tr>	
<script src="https://developers.kakao.com/sdk/js/kakao.js"></script>
<script type="text/javascript">
