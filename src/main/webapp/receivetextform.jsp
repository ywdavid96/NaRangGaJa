...
<%@page import="text.service.TextService"%>
...
<body>
	...
	<article id="box">
	<article id="box2">
	<button id="text" onclick="location='receivetextform.jsp'">받은 쪽지</button>
	<button id="text" style="margin-right:30px;" onclick="location='sendtextform.jsp'">보낸 쪽지</button>
	</article>
	<article id="box3">
	<h1>받은 쪽지</h1>
	...
	<%
		...
		ResultSet rs = service.receiveList(id);
		while(rs.next())
		{
		%>
		<tr>
			<form action="textDetail.jsp">
			<td>
			<input type="submit" name="title" value="<%=rs.getString(4)%>">
			</td>
			</form>
	...
	<input type="button" style="float:right; margin-right:50px; margin-top:10px;" value="쪽지보내기" onclick="location='writetextform.jsp'">
	</article>
