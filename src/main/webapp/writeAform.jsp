...
<body>
	...
	<table style="margin-left:200px; line-height:50px;">
		...
		<tr>
			<th>제목</th>
			<td>
				<input type="text" name="title" style="width: 800px; margin:10px 10px;" value="<%=title%>" readonly>
			</td>
		</tr>
		<tr>
			<th>아이디:</th>
	...
	<input type="submit" value="답변완료" style="float:right; margin-top:25px;">
