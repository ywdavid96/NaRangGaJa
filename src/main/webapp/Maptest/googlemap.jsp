...
doc
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCaUPr8wXa7lt837OCS96ATK7dVBHamsSA&libraries=places&callback=initMap"
        defer></script>
  ...
  <body>
   <div id="map"></div>
    <div id="infowindow-content">
  	...
  	<form id="frm" name="frm" action="mapInsert.do" method="post">
...
주소 <input type="text" id="address" name="paddress" value="">
장소 <input type="text" id="place_name" name="pname" value="">

    </div>   
    <input id="ub" type ="submit" value ="확인"> 
 </form>   
  </body>
</html>