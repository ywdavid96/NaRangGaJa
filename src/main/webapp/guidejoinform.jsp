...
<body>
	...
	<h1 style="text-align:center;">가이드 회원가입</h1>
	<br>
	<form action="guideInsert.do">
		<div class="main">
			<div class="site1">
				<div class="main_1 main_common">아이디</div>
				<input id="form_box" type="text" class="int" maxlength="20"
					title="아이디 입력" placeholder="사용할 아이디를 입력해 주세요" name="Guide_ID">
			</div>
			<div class="site1">
				<div class="main_2 main_common">비밀번호</div>
				<input id="form_box" type="password" class="int" maxlength="20"
					title="비밀번호 입력" placeholder="사용할 비밀번호를 입력해 주세요" name="Guide_PWD">
			</div>
			<div class="site1">
				<div class="main_3 main_common">이름</div>
				<input id="form_box" type="text" title="이름 입력"
					placeholder="이름을 입력해주세요" name="Guide_name">
			</div>
			<div class="site1">
				<div class="main_4 main_common">SNS</div>
				<label><input type="radio" name="SNS_code" value="1">페이스북</label> <label>
				<input type="radio" name="SNS_code" value="2">인스타그램</label> <label>
				<input type="radio" name="SNS_code" value="3">카카오톡</label> <label>
				<input type="radio" name="SNS_code" value="4">라인</label>
			</div>
			<div class="site1">
			...
			<div class="site1">
				<div class="main_6 main_common">일급</div>
				<input id="form_box" type="text" title="일급 입력"
					placeholder="일급을 입력해주세요" name="Payment">
			</div>
			<div class="site1">
				<div class="main_7 main_common">성별</div>
				<label><input type="radio" name="Gender" value="남자">남자</label> 
				<label><input type="radio" name="Gender" value="여자">여자</label>
			</div>
			<div class="site1">
				<div class="main_8 main_common">나이</div>
