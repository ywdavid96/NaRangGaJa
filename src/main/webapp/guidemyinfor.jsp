...
<body>
	...
	%>
	<div class="infor" style="background-color:#FFFAFA;">
		<header class="head">
		<h1>&nbsp;&nbsp;정보변경</h1>
		</header>
		<%
		...
		<div class="container">
			<ul>
				<li style="text-align: left"><p class="normal"
						style="padding-bottom: 15px; border-bottom: 2px dotted black">회원정보수정</p></li>
				<br>
				<br>
			</ul>

			<form action="guideUpdate.do" method="get">
			&nbsp;&nbsp;아이디&nbsp;:&nbsp;&nbsp;&nbsp;<input type="text" readonly value=<%=rs.getString(1)%> name="Guide_ID">
			비밀번호 : <input type="text" value=<%=rs.getString(2)%> name="Guide_PWD"><br> <br>
			&nbsp;&nbsp;이&nbsp;&nbsp;름&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(3)%> name="Guide_name">
			&nbsp;&nbsp;S&nbsp;N&nbsp;S : &nbsp;&nbsp;<input type="text" value=<%=rs.getString(4)%> name="SNS_code"><br> <br>
			&nbsp;&nbsp;일&nbsp;&nbsp;급&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(5)%> name="Payment">
			&nbsp;&nbsp;지&nbsp;&nbsp;역&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(6)%> name="Region"><br> <br>
			&nbsp;&nbsp;성&nbsp;&nbsp;별&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(7)%> name="Gender">
			&nbsp;&nbsp;나&nbsp;&nbsp;이&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value=<%=rs.getString(8)%> name="Age"><br> <br>	
				<br> <input id="ub" type="submit" value="정보 수정">
			</form>
			<form action="guideDelete.do">
				<input id="ub" type="submit" value="회원탈퇴">
			</form>
